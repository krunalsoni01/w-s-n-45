  ...
  while ((tag = input->ReadTag()) != 0) {
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 5: {
        ...
        if (input->ExpectTag(48)) goto parse_reverse_sample_rate;
        break;
      }
      ...
      case 6: {
        ...
        if (input->ExpectTag(56)) goto parse_output_sample_rate;
        break;
      }
  ...
  while ((tag = input->ReadTag()) != 0) {
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 5: {
        ...
        if (input->ExpectTag(48)) goto parse_keypress;
        break;
      }
      ...
      case 6: {
        ...
        if (input->ExpectTag(58)) goto parse_input_channel;
        break;
      }
      ...
      case 7: {
        ...
        if (input->ExpectTag(58)) goto parse_input_channel;
        if (input->ExpectTag(66)) goto parse_output_channel;
        break;
      }
...
void Stream::Swap(Stream* other) {
  if (other != this) {
    ...
    input_channel_.Swap(&other->input_channel_);
    output_channel_.Swap(&other->output_channel_);
    std::swap(_has_bits_[0], other->_has_bits_[0]);
    std::swap(_cached_size_, other->_cached_size_);
  }
}
